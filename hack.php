...
<h4 id="switchcoding"  class="fn1 fw my-5"><br><br><br>  </h4>

            <p class="f2 c-theme-2 p-5 black-box" style="text-space: 3px"><br><br>
            	<img src="hak.gif" style="width: 100%;height: 100%;">
            	
                <br><br>
             "Sometimes the best way to learn to swim is to get thrown in the ocean"<br>
             <br>You bring your ideas, and we give you everything you need to make them come to life.<br>
              We at VSSUT invite you all to VHacks , a 24-hour hackathon organised by Prajwalit.<br> At VHacks, we want to help you turn your ideas into reality.<br> 
              You're welcome to come with or without a team.<br>
              We'll provide you with all the resources and mentors you need to help you work on something cool or learn new skills.<br>
              You'll have the freedom to create a product, learn new techniques for your future work, or just have fun working on a project with friends.<br>
            For newcomers and veterans alike, VHacks is a weekend experience you won’t want to miss.<br>
                  ...
                  <br><br><span style="font-size:200%;">Rules</span>
            <br><br>
                 No of candidates in each team :1-2<br>
   Participants (“hackers”) spend 24 hours working in teams of 1 - 2 people to build a website. <br>
